...
import viajeEfectuado from './routes/viajeEfectuado.routes'
import tipoCarga from './routes/tipoCarga.routes'
//middlewares
app.use(json())
app.use(morgan('dev'))
app.use(cors())
...
app.use('/api/viajeefectuado', viajeEfectuado)
app.use('/api/tipocarga',tipoCarga)
export default app;
module.exports = app;